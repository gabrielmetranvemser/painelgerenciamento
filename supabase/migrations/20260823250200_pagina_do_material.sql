-- =============================================================================
-- A página que a pessoa abre: /m/{token}
-- =============================================================================
-- Um token, uma consulta. A página precisa do candidato, das peças ativas dele
-- com link rastreado próprio, e de saber se aquela pessoa já pediu para sair.
--
-- Só o servidor chama (service_role). O anônimo não enxerga nem a tabela nem
-- esta função — é a rota que decide o que mostrar.
...
revoke execute on function public.pagina_material(text) from anon, public, authenticated;
